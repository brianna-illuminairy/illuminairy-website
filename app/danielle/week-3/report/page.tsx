...
export default async function DanielleWeek3ReportPage() {
  if (!isDanielleConfigured()) {
    return <DanielleNotConfigured />;
  }

  await requireDanielleAuth("/danielle/week-3/report");
  const { styles, bodyHtml } = readDanielleWeeklyReportHtml("week-3");
