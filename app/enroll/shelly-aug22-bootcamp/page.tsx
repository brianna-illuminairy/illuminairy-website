...
const SLUG = "shelly-aug22-bootcamp";

export const metadata: Metadata = {
  title: "August 22 SAT Bootcamp enrollment | Illuminairy",
  description:
    "August 22 SAT Bootcamp enrollment for Shelly Sood. Family diagnostic bundle, $175/week tutoring with the first week free.",
  robots: { index: false, follow: false }
};

export const dynamic = "force-dynamic";

export default async function ShellyAug22BootcampEnrollPage() {
