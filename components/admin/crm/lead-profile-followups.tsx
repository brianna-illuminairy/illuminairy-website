...
/**
 * The action-oriented "what do I need to do right now" panel. Lives on
 * the Overview tab of the lead profile. Long-form sales notes are in
 * their own tab via LeadProfileSalesNotes.
 */
export function LeadProfileFollowups({
  detail,
  saving,
  onPatch
}: {
