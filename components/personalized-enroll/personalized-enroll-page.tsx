  ...
  const faqs: Array<{ q: string; a: string[] }> = [
    ...
    },
    {
      ...
      a: [
        ...
        "We do not require tutors to retake the SAT on a fixed schedule. Most working tutors will not, for the same reason a chef does not retake culinary school. Per-tutor outcome tracking is a more reliable currency check than a retake quota. And we hold company-wide trainings any time anything changes on the SAT.",
