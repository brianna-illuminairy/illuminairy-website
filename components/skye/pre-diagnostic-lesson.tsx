...
const STRATEGY_ITEMS = [
  ...
  "First pass on Reading & Writing: about 1 minute per question, then Mark for Review and move on.",
  "First pass on Math: about 1½ minutes per question, then Mark for Review and move on.",
