...
function SkyeHeaderNav({ pathname }: { pathname: string }) {
  return (
...
export function SkyePortalShell({ children }: { children: React.ReactNode }) {
    ...
    <div className="aurora-portal">
      <header className="aurora-header">
        <div className="aurora-header__inner" style={{ flexDirection: "column", alignItems: "stretch" }}>
          ...
          <SkyeHeaderNav pathname={pathname} />
        </div>
      </header>
...
export function SkyeLoginChrome({ children }: { children: React.ReactNode }) {
  return (
