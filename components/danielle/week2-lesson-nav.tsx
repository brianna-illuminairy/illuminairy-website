    ...
    <div className="danielle-portal__week1-subnav">
      <div className="danielle-portal__week1-subnav-inner">
        <label className="danielle-portal__week1-picker">
          <span className="danielle-portal__week1-picker-label">Week 2 lesson</span>
          <select
            className="danielle-portal__week1-select"
            value={active}
            onChange={(e) => router.push(e.target.value)}
            aria-label="Choose Week 2 lesson"
          >
            {LESSONS.map((lesson) => (
        ...
        <div className="danielle-portal__week1-tabs" aria-label="Week 2 lessons">
          {LESSONS.map((lesson) => {
