# Skye — Week 2 Session 1 follow-up email (draft)

**To:** skyelacrosse13@gmail.com  
**Cc:** sara_crisafulli@hotmail.com *(optional)*  
**From:** brianna@illuminairy.com  
**Subject:** Today's session notes + homework (Equivalent Expressions 1 & 2)
...
3. Open **Improvement Plan** → Week 2 → **Open Session 1 lesson**, or go directly to:

   **https://illuminairy.com/skye/week-2/lesson-1**
...
Homework is on a **separate site** — same Illuminairy account, different login flow.

1. Go to **https://my.illuminairy.com/login**
...
We'll work through any problems you got **incorrect or skipped** from Equivalent Expressions 1 and 2. Finish both sets before we meet so we can spend the time on your misses.

Reply if anything doesn't open or you don't see the homework sets.
