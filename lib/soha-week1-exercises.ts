...
export const WEEK1_EXERCISES: SohaWeek1Exercise[] = [
  {
    ...
    instructions: [
      "Run after Lesson 1 and after you set up your mistake log.",
...
/** @deprecated Use WEEK1_EXERCISES */
export const WEEK1_POST_SESSION_EXERCISES = WEEK1_EXERCISES;

export function getWeek1Exercise(id: string) {
  return WEEK1_EXERCISES.find((exercise) => exercise.id === id);
}
