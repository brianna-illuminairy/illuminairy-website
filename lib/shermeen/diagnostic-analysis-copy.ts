...
export const SHERMEEN_ADAPTIVE_RW = [
  "On Reading and Writing Module 1, Shermeen got 21 out of 27 correct (77.8%). The test usually requires about 18 correct on Module 1 before it assigns the harder Module 2. She cleared that bar by three questions.",
  "That is good for her score. The harder Module 2 includes more hard questions. Those questions are what allow a Reading and Writing section score above the mid range. If she had missed that cutoff, Module 2 would have stayed easier and her section score would have been limited even if she did well on Module 2.",
  "In the harder Module 2 she got 13 out of 27 correct. Most of her Reading and Writing wrong answers were in Module 2, but six of her seven Module 1 wrong answers were easy or medium questions on grammar, transitions, evidence, and rhetorical synthesis. Those are the same types she missed most often on easy and medium questions.",
];

export const SHERMEEN_ADAPTIVE_MATH = [
  "On Math Module 1, Shermeen got 16 out of 22 correct (72.7%). The test usually requires about 13 or 14 correct on Module 1 before it assigns the harder Module 2. She cleared that bar.",
  "That unlocked the harder Math Module 2, which allows a higher section score than the easier Module 2 path would. In Module 2 she got 14 out of 22 correct.",
  "The work now is fixing the question types she missed in Module 1 before they show up again in Module 2, and tightening medium-difficulty Math where she was at 50% across the full section.",
];

export const SHERMEEN_RW_INTRO_LEAD =
  `Shermeen missed 20 Reading and Writing questions across both modules. They fell across transitions, command of evidence, form and structure, boundaries, text structure, central ideas, inferences, rhetorical synthesis, and words in context. She scored 70% on hard questions and 38% on easy. Most of her wrong answers were on easy or medium questions. Students who miss easy and medium questions in many Reading and Writing skills usually need to learn each question type, how to tell what it is asking, and the method to use before reading the answer choices. Shermeen's results match that pattern. In Module 1 she answered hard craft-and-structure and central-ideas questions correctly while missing easy transition, evidence, and rhetorical synthesis questions. On most wrong answers she chose an answer that fit the passage topic but did not answer what that question type required.`;

export const SHERMEEN_RW_PLAN_NOTE =
  "Even though her misses fall across many skills, we still teach one skill at a time in ranked order. Each session we teach the question type, how to identify what it is asking, and the best method to use, then walk through examples until she has it memorized. The goal is for her to know the type and method from memory so she can start right away instead of spending minutes on setup or reading every choice first. Timed practice on that skill follows until she hits 95%+ accuracy on medium questions before we move to the next.";
...
export const SHERMEEN_RW_SKILLS: RwSkillBlock[] = [
  ...
  },
  {
    ...
    body: [
      ...
      {
        kind: "ul",
        intro: "The rules we teach in tutoring:",
        items: [
          {
...
export const SHERMEEN_MATH_INTRO = [
  ...
  "When I reviewed each wrong answer in Mentomind, most of the misses were medium-difficulty questions in several different topics, not one narrow skill. Students who miss medium questions in several Math areas usually need to learn the question types, what each one is asking, and which method to use first. Shermeen's wrong answers match that pattern. Module 1 Question 14 is a clear example: she found the x-intercept (h = 4) but did not finish with h + k. On Module 2 Question 20 she answered in 19 seconds on a factor-theorem problem, which suggests she had not named the setup step yet. Several other misses on factoring, circle tangency, and arc length work the same way: once she knows the question type and the method, the algebra is straightforward.",
  "Several questions that look different on the surface (quadratic equations, equivalent expressions, the factor theorem, even setting up a probability table) all require the same move once named: rearrange to zero, factor out a common piece, verify factors by expanding, or use f(r) = 0 when a factor is given. That is the first topic I would teach her, before we add more Desmos practice on top.",
  ...
  "We build that foundation in tutoring by teaching the question types, how to identify what is being asked, and the best method to solve. We go through examples every session until she has them memorized. When she knows the type and method right away, she can start the math immediately instead of spending the first minute on setup. That helps her finish the module without rushing or guessing on the last questions. Desmos helps only after that setup is clear.",
];
...
export const SHERMEEN_MATH_GAP2 =
  "The second area is circles and geometry formulas that are not fully spelled out on the SAT reference sheet. On Module 1 Question 13 she added π/4 and π/6 but converted to 60° instead of 75°. On Module 1 Question 21 she spent 158 seconds on arc length and picked 40 when the only integer in the valid range is 39. On Module 2 Question 10 she left a grid-in blank after 37 seconds on a circle tangency problem (center at (p, 18), tangent to both axes, find k + p). Those three misses share the same fix: memorize the radian-to-degree formula (degrees = radians × 180 / π), memorize arc length as a fraction of circumference, and know by heart that tangency to both axes means the radius equals the distance from the center to each axis. Then read what the question is asking for at the end.";

export const SHERMEEN_MATH_GAP2_RESOLVE =
  "In Phase 1 tutoring I would walk through each formula and relationship until she has them memorized: radian-to-degree conversion, arc length as a fraction of circumference, and what tangency to both axes tells you about radius and center coordinates. We would practice setting up each question type until she can write the inequality or grid-in answer without hesitating.";
...
export const SHERMEEN_MATH_SKILLS_INTRO = [
  "If I rank these by how many points she likely lost on her total score, factoring and equivalent-form fluency come first. Those appear on Module 1 Question 9, Module 2 Questions 9 and 20, and again on Module 2 Question 2. After that: linear functions and word problems (Module 1 Question 14, Module 2 Question 4), circle formulas including arc length and tangency (Module 1 Questions 13 and 21, Module 2 Question 10 blank), and reading statistics carefully (Module 2 Question 1).",
];

export const SHERMEEN_MATH_QUESTION_TYPES =
  "A large part of SAT Math is knowing the question type before you calculate. The SAT reuses the same types, and the same topic can look different depending on the wording. Once she knows the type, what it is asking, and the method to use, she can start solving right away instead of spending the first minute on setup. In tutoring we teach what each type looks like, how to identify what is being asked, and the best approach: two points and \"find the equation\" means write a line equation; a grid-in with a system means solve and enter the exact value; a circle question with a diagram means write down the radius or arc formula first. We review examples on each type every session until she has the type, what it is asking, and the method memorized. Starting fast on each question helps her finish the module without rushing.";
...
export const SHERMEEN_TIMING_INTRO = [
  "The full diagnostic report shows how many seconds Shermeen spent on each question compared to the average for other students. Below I analyze her timing across questions and only call out patterns that help explain a miss. Normal variation exists. Spending extra time on a hard question she eventually gets right is not necessarily a problem if the rest of the module stays on pace.",
  "On this test, much of the lost time came from slow setup or reading every choice and still missing, or from quick wrong guesses near the end because earlier questions took too long. When she knows the question type and method right away, she can start solving and is less likely to run out of time before the module ends.",
];
...
export const SHERMEEN_SKIP_TIME = {
  reading:
    "Hard craft-and-structure and hard central-ideas questions in Module 1 were mostly correct. She did not miss cross-text connections questions. Session time is better spent on transitions, command of evidence, boundaries, form and structure, and rhetorical synthesis.",
  math: "Easy Math questions were strong (92% correct). Ratios, two-variable data, margin of error, lines and angles, and area and volume in Module 1 were mostly correct. She already handles basic data and geometry questions well.",
};
