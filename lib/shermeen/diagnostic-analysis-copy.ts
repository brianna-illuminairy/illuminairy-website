...
export const SHERMEEN_OVERVIEW_INTRO = [
  ...
  "Shermeen did better on hard Reading and Writing questions than on easy ones there, scoring 70% on hard and 38% on easy. That usually means she is not yet familiar with the SAT question types, what each one is asking, and the best approach or method to apply to arrive at the correct answer. Easy questions on this test tend to test one specific rule or question type. Hard questions often reward working through a longer passage. When the types and methods are not memorized yet, easy questions can miss more often than hard ones.",
