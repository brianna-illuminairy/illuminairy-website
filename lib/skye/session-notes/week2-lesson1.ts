...
export const SKYE_HOMEWORK_PORTAL_SETS: SkyeHomeworkPortalSet[] = [
  {
    ...
    note: "10 easy problems — warm-up before the medium set. Complete before your next session.",
  },
  {
    id: "equivalent-expressions-2",
    title: "Equivalent Expressions 2",
    note: "20 medium problems — complete after Equivalent Expressions 1, before your next session.",
  },
];
...
export const WEEK2_LESSON1 = {
  ...
  homework: {
    ...
    body:
      "Two problem sets in the Homework Portal. Complete Equivalent Expressions 1 (easy warm-up), then Equivalent Expressions 2 (medium), before our next session.",
  },
  nextSession: {
