...
function prepPersonalizationLine(prepIds: PrepId[], subject: string): string | null {
...
/**
 * INT13 kid-problem screens removed from funnel (2026-05).
 * Do not re-enable in routing unless Brianna explicitly requests it.
 */
export function shouldShowKidProblem(_prepMethod?: SatPlanAnswers["prep_method"]): boolean {
  return false;
}
